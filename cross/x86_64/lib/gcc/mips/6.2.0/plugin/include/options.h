...
enum opt_code
{
  ...
  OPT_Wpragmas = 351,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 352,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 353,                       /* -Wprotocol */
  OPT_Wpsabi = 354,                          /* -Wpsabi */
  OPT_Wraw = 355,                            /* -Wraw */
  OPT_Wreal_q_constant = 356,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 357,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 358,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 359,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 360,            /* -Wredundant-modifiers */
  OPT_Wreorder = 361,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 362,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 363,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 364,           /* -Wscalar-storage-order */
  OPT_Wselector = 365,                       /* -Wselector */
  OPT_Wsequence_point = 366,                 /* -Wsequence-point */
  OPT_Wserial = 367,                         /* -Wserial */
  OPT_Wshadow = 368,                         /* -Wshadow */
  OPT_Wshadow_ivar = 369,                    /* -Wshadow-ivar */
  ...
  OPT_Wsizeof_pointer_memaccess = 380,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 381,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 382,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 383,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 384,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 385,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 386,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 387,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 388,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 389,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 390,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 391,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 392,          /* -Wstrict-selector-match */
  OPT_Wsubobject_linkage = 393,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 394,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 395,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 396,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 397,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 398,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 399,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 400,               /* -Wsuggest-override */
  OPT_Wsuppress = 401,                       /* -Wsuppress */
  ...
  OPT_Wsync_nand = 407,                      /* -Wsync-nand */
  OPT_Wsynth = 408,                          /* -Wsynth */
  OPT_Wsynthetic_access = 409,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 410,                 /* -Wsystem-headers */
  OPT_Wtabs = 411,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 412,                /* -Wtarget-lifetime */
  OPT_Wtasks = 413,                          /* -Wtasks */
  OPT_Wtautological_compare = 414,           /* -Wtautological-compare */
  OPT_Wtemplates = 415,                      /* -Wtemplates */
  OPT_Wterminate = 416,                      /* -Wterminate */
  OPT_Wtraditional = 417,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 418,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 419,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 420,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 421,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 422,                    /* -Wtype-limits */
  OPT_Wuncheck = 423,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 424,            /* -Wundeclared-selector */
  OPT_Wundef = 425,                          /* -Wundef */
  OPT_Wunderflow = 426,                      /* -Wunderflow */
  OPT_Wuninitialized = 427,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 428,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 429,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 430,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 431, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 432,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 433,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 434,                         /* -Wunused */
  OPT_Wunused_argument = 435,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 436,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 437,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 438, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 439,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 440,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 441,                /* -Wunused-function */
  OPT_Wunused_import = 442,                  /* -Wunused-import */
  OPT_Wunused_label = 443,                   /* -Wunused-label */
  OPT_Wunused_local = 444,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 445,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 446,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 447,               /* -Wunused-parameter */
  OPT_Wunused_private = 448,                 /* -Wunused-private */
  OPT_Wunused_result = 449,                  /* -Wunused-result */
  OPT_Wunused_thrown = 450,                  /* -Wunused-thrown */
  OPT_Wunused_value = 451,                   /* -Wunused-value */
  OPT_Wunused_variable = 452,                /* -Wunused-variable */
  OPT_Wuse_without_only = 453,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 454,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 455,             /* -Wuseless-type-check */
  OPT_Wvarargs = 456,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 457,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 458,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 459,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 460,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 461,            /* -Wvirtual-move-assign */
  OPT_Wvla = 462,                            /* -Wvla */
  OPT_Wvolatile_register_var = 463,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 464,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 465,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 466,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 467,                       /* -Wzerotrip */
  OPT_Xassembler = 468,                      /* -Xassembler */
  OPT_Xlinker = 469,                         /* -Xlinker */
  OPT_Xpreprocessor = 470,                   /* -Xpreprocessor */
  OPT_Z = 471,                               /* -Z */
  OPT_ansi = 472,                            /* -ansi */
  OPT_aux_info = 473,                        /* -aux-info */
  /* OPT_aux_info_ = 474, */                 /* -aux-info= */
  OPT_auxbase = 475,                         /* -auxbase */
  OPT_auxbase_strip = 476,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 477, */             /* -bootclasspath */
  OPT_c = 478,                               /* -c */
  /* OPT_classpath = 479, */                 /* -classpath */
  OPT_coverage = 480,                        /* -coverage */
  OPT_cpp = 481,                             /* -cpp */
  OPT_cpp_ = 482,                            /* -cpp= */
  OPT_d = 483,                               /* -d */
  OPT_dumpbase = 484,                        /* -dumpbase */
  OPT_dumpdir = 485,                         /* -dumpdir */
  OPT_dumpmachine = 486,                     /* -dumpmachine */
  OPT_dumpspecs = 487,                       /* -dumpspecs */
  OPT_dumpversion = 488,                     /* -dumpversion */
  OPT_e = 489,                               /* -e */
  /* OPT_encoding = 490, */                  /* -encoding */
  OPT_export_dynamic = 491,                  /* -export-dynamic */
  OPT_extdirs = 492,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 493, */               /* -fCLASSPATH= */
  OPT_fPIC = 494,                            /* -fPIC */
  OPT_fPIE = 495,                            /* -fPIE */
  OPT_fRTS_ = 496,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 497,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 498,                   /* -fabi-version= */
  OPT_faccess_control = 499,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 500,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 501,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 502,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 503,                  /* -falign-commons */
  OPT_falign_functions = 504,                /* -falign-functions */
  OPT_falign_functions_ = 505,               /* -falign-functions= */
  OPT_falign_jumps = 506,                    /* -falign-jumps */
  OPT_falign_jumps_ = 507,                   /* -falign-jumps= */
  OPT_falign_labels = 508,                   /* -falign-labels */
  OPT_falign_labels_ = 509,                  /* -falign-labels= */
  OPT_falign_loops = 510,                    /* -falign-loops */
  OPT_falign_loops_ = 511,                   /* -falign-loops= */
  OPT_fall_intrinsics = 512,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 513, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 514,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 515,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 516, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 517, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 518, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 519, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 520, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 521,            /* -fasan-shadow-offset= */
  OPT_fasm = 522,                            /* -fasm */
  OPT_fassert = 523,                         /* -fassert */
  OPT_fassociative_math = 524,               /* -fassociative-math */
  OPT_fassume_compiled = 525,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 526,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 527,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 528,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 529,                   /* -fauto-profile */
  OPT_fauto_profile_ = 530,                  /* -fauto-profile= */
  OPT_fautomatic = 531,                      /* -fautomatic */
  OPT_faux_classpath = 532,                  /* -faux-classpath */
  OPT_fbackslash = 533,                      /* -fbackslash */
  OPT_fbacktrace = 534,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 535,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 536,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 537,              /* -fbootstrap-classes */
  OPT_fbounds_check = 538,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 539,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 540,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 541,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 542,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 543,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 544,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 545,                        /* -fbuiltin */
  OPT_fbuiltin_ = 546,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 547,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 548,                    /* -fcall-saved- */
  OPT_fcall_used_ = 549,                     /* -fcall-used- */
  OPT_fcaller_saves = 550,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 551,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 552,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 553,                /* -fcheck-data-deps */
  OPT_fcheck_new = 554,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 555,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 556,               /* -fcheck-references */
  OPT_fcheck_ = 557,                         /* -fcheck= */
  OPT_fchecking = 558,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 559,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 560,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 561,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 562,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 563,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 564,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 565,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 566, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 567,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 568,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 569,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 570, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 571,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 572,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 573,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 574,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 575,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 576,                       /* -fcilkplus */
  OPT_fclasspath_ = 577,                     /* -fclasspath= */
  OPT_fcoarray_ = 578,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 579,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 580,                         /* -fcommon */
  OPT_fcompare_debug = 581,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 582,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 583,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 584,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 585,              /* -fcompile-resource= */
  OPT_fconcepts = 586,                       /* -fconcepts */
  OPT_fcond_mismatch = 587,                  /* -fcond-mismatch */
  OPT_fconserve_space = 588,                 /* -fconserve-space */
  OPT_fconserve_stack = 589,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 590,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 591,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 592,                       /* -fconvert= */
  OPT_fcprop_registers = 593,                /* -fcprop-registers */
  OPT_fcray_pointer = 594,                   /* -fcray-pointer */
  OPT_fcrossjumping = 595,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 596,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 597, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 598,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 599,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 600,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 601,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 602,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 603,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 604,                       /* -fdbg-cnt= */
  OPT_fdce = 605,                            /* -fdce */
  OPT_fdebug_cpp = 606,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 607,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 608,            /* -fdebug-types-section */
  OPT_fdec = 609,                            /* -fdec */
  ...
  OPT_fdefault_real_8 = 616,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 617,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 618,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 619,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 620,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 621,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 622,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 623,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 624, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 625,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 626,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 627,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 628,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 629,                /* -fdirectives-only */
  OPT_fdisable_ = 630,                       /* -fdisable- */
  OPT_fdisable_assertions = 631,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 632,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 633,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 634,         /* -fdollars-in-identifiers */
  OPT_fdse = 635,                            /* -fdse */
  OPT_fdump_ = 636,                          /* -fdump- */
  OPT_fdump_ada_spec = 637,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 638,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 639, */                /* -fdump-core */
  OPT_fdump_final_insns = 640,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 641,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 642,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 643,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 644,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 645,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 646,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 647, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 648,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 649,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 650,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 651,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 652,                 /* -fearly-inlining */
  OPT_felide_constructors = 653,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 654,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 655, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 656,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 657,        /* -femit-class-debug-always */
  OPT_femit_class_file = 658,                /* -femit-class-file */
  OPT_femit_class_files = 659,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 660,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 661,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 662,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 663,                        /* -fenable- */
  OPT_fenable_assertions = 664,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 665,             /* -fenable-assertions= */
  OPT_fencoding_ = 666,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 667,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 668, */           /* -fenum-int-equiv */
  OPT_fexceptions = 669,                     /* -fexceptions */
  OPT_fexcess_precision_ = 670,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 671,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 672,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 673,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 674,                       /* -fextdirs= */
  OPT_fextended_identifiers = 675,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 676,                /* -fextern-tls-init */
  OPT_fexternal_blas = 677,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 678, */       /* -fexternal-templates */
  OPT_ff2c = 679,                            /* -ff2c */
  OPT_ffast_math = 680,                      /* -ffast-math */
  OPT_ffat_lto_objects = 681,                /* -ffat-lto-objects */
  ...
  OPT_mabi_ = 1184,                          /* -mabi= */
  OPT_mabicalls = 1185,                      /* -mabicalls */
  OPT_mabs_ = 1186,                          /* -mabs= */
  OPT_march_ = 1187,                         /* -march= */
  OPT_mbranch_cost_ = 1188,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1189,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1190,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1191,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1192,             /* -mcompact-branches= */
  OPT_mdebug = 1193,                         /* -mdebug */
  OPT_mdebugd = 1194,                        /* -mdebugd */
  OPT_mdivide_breaks = 1195,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1196,                  /* -mdivide-traps */
  OPT_mdmx = 1197,                           /* -mdmx */
  OPT_mdouble_float = 1198,                  /* -mdouble-float */
  OPT_mdsp = 1199,                           /* -mdsp */
  OPT_mdspr2 = 1200,                         /* -mdspr2 */
  OPT_meb = 1201,                            /* -meb */
  OPT_mel = 1202,                            /* -mel */
  OPT_membedded_data = 1203,                 /* -membedded-data */
  OPT_meva = 1204,                           /* -meva */
  OPT_mexplicit_relocs = 1205,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1206,                  /* -mextern-sdata */
  OPT_mfix_24k = 1207,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1208,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1209,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1210,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1211,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1212,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1213,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1214,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1215,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1216,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1217,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1218,                 /* -mfp-exceptions */
  OPT_mfp32 = 1219,                          /* -mfp32 */
  OPT_mfp64 = 1220,                          /* -mfp64 */
  OPT_mfpxx = 1221,                          /* -mfpxx */
  OPT_mframe_header_opt = 1222,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1223, */              /* -mfused-madd */
  OPT_mgp32 = 1224,                          /* -mgp32 */
  OPT_mgp64 = 1225,                          /* -mgp64 */
  OPT_mgpopt = 1226,                         /* -mgpopt */
  OPT_mhard_float = 1227,                    /* -mhard-float */
  OPT_mimadd = 1228,                         /* -mimadd */
  OPT_minterlink_compressed = 1229,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1230,              /* -minterlink-mips16 */
  OPT_mips = 1231,                           /* -mips */
  OPT_mips16 = 1232,                         /* -mips16 */
  OPT_mips3d = 1233,                         /* -mips3d */
  OPT_mllsc = 1234,                          /* -mllsc */
  OPT_mload_store_pairs = 1235,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1236,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1237,                    /* -mlong-calls */
  OPT_mlong32 = 1238,                        /* -mlong32 */
  OPT_mlong64 = 1239,                        /* -mlong64 */
  OPT_mlra = 1240,                           /* -mlra */
  OPT_mmad = 1241,                           /* -mmad */
  OPT_mmcount_ra_address = 1242,             /* -mmcount-ra-address */
  OPT_mmcu = 1243,                           /* -mmcu */
  OPT_mmemcpy = 1244,                        /* -mmemcpy */
  OPT_mmicromips = 1245,                     /* -mmicromips */
  OPT_mmt = 1246,                            /* -mmt */
  OPT_mnan_ = 1247,                          /* -mnan= */
  OPT_mno_float = 1248,                      /* -mno-float */
  OPT_mno_flush_func = 1249,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1250,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1251,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1252,                     /* -mno-mips3d */
  OPT_modd_spreg = 1253,                     /* -modd-spreg */
  OPT_mpaired_single = 1254,                 /* -mpaired-single */
  OPT_mplt = 1255,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1256,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1257,               /* -mrelax-pic-calls */
  OPT_mshared = 1258,                        /* -mshared */
  OPT_msingle_float = 1259,                  /* -msingle-float */
  OPT_msmartmips = 1260,                     /* -msmartmips */
  OPT_msoft_float = 1261,                    /* -msoft-float */
  OPT_msplit_addresses = 1262,               /* -msplit-addresses */
  OPT_msym32 = 1263,                         /* -msym32 */
  OPT_msynci = 1264,                         /* -msynci */
  OPT_mtune_ = 1265,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1266,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1267,                          /* -mvirt */
  OPT_mvr4130_align = 1268,                  /* -mvr4130-align */
  OPT_mxgot = 1269,                          /* -mxgot */
  OPT_mxpa = 1270,                           /* -mxpa */
  OPT_n = 1271,                              /* -n */
  OPT_no_canonical_prefixes = 1272,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1273,              /* -no-integrated-cpp */
  OPT_no_pie = 1274,                         /* -no-pie */
  OPT_noasmopt = 1275,                       /* -noasmopt */
  OPT_nocpp = 1276,                          /* -nocpp */
  OPT_nodefaultlibs = 1277,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1278,                   /* -nostartfiles */
  OPT_nostdinc = 1279,                       /* -nostdinc */
  OPT_nostdinc__ = 1280,                     /* -nostdinc++ */
  OPT_nostdlib = 1281,                       /* -nostdlib */
  OPT_o = 1282,                              /* -o */
  OPT_p = 1283,                              /* -p */
  OPT_pass_exit_codes = 1284,                /* -pass-exit-codes */
  /* OPT_pedantic = 1285, */                 /* -pedantic */
  OPT_pedantic_errors = 1286,                /* -pedantic-errors */
  OPT_pg = 1287,                             /* -pg */
  OPT_pie = 1288,                            /* -pie */
  OPT_pipe = 1289,                           /* -pipe */
  ...
  OPT_r = 1302,                              /* -r */
  OPT_remap = 1303,                          /* -remap */
  OPT_s = 1304,                              /* -s */
  OPT_s_bc_abi = 1305,                       /* -s-bc-abi */
  OPT_save_temps = 1306,                     /* -save-temps */
  OPT_save_temps_ = 1307,                    /* -save-temps= */
  OPT_shared = 1308,                         /* -shared */
  OPT_shared_libgcc = 1309,                  /* -shared-libgcc */
  /* OPT_specs = 1310, */                    /* -specs */
  OPT_specs_ = 1311,                         /* -specs= */
  OPT_static = 1312,                         /* -static */
  OPT_static_libasan = 1313,                 /* -static-libasan */
  OPT_static_libgcc = 1314,                  /* -static-libgcc */
  OPT_static_libgcj = 1315,                  /* -static-libgcj */
  ...
  OPT_static_libstdc__ = 1321,               /* -static-libstdc++ */
  OPT_static_libtsan = 1322,                 /* -static-libtsan */
  OPT_static_libubsan = 1323,                /* -static-libubsan */
  /* OPT_std_c__03 = 1324, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1325, */                /* -std=c++0x */
  OPT_std_c__11 = 1326,                      /* -std=c++11 */
  OPT_std_c__14 = 1327,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1328, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1329, */                /* -std=c++1y */
  OPT_std_c__1z = 1330,                      /* -std=c++1z */
  OPT_std_c__98 = 1331,                      /* -std=c++98 */
  OPT_std_c11 = 1332,                        /* -std=c11 */
  ...
  OPT_std_f95 = 1341,                        /* -std=f95 */
  OPT_std_gnu = 1342,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1343, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1344, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1345,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1346,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1347, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1348, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1349,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1350,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1351,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1352, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1353, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1354,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1355,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1356, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1357, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1358,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1359, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1360, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1361, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1362,                     /* -std=legacy */
  OPT_symbolic = 1363,                       /* -symbolic */
  OPT_t = 1364,                              /* -t */
  OPT_time = 1365,                           /* -time */
  OPT_time_ = 1366,                          /* -time= */
  OPT_traditional = 1367,                    /* -traditional */
  OPT_traditional_cpp = 1368,                /* -traditional-cpp */
  OPT_trigraphs = 1369,                      /* -trigraphs */
  OPT_u = 1370,                              /* -u */
  OPT_undef = 1371,                          /* -undef */
  OPT_v = 1372,                              /* -v */
  OPT_version = 1373,                        /* -version */
  OPT_w = 1374,                              /* -w */
  OPT_wrapper = 1375,                        /* -wrapper */
  OPT_x = 1376,                              /* -x */
  OPT_z = 1377,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
